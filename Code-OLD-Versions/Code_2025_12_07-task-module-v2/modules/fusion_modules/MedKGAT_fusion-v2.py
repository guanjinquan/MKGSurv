...
--- Testing Complete ---
Validation Summary:
C-Index_Validation Set: 0.6445 ± 0.0436
 - List = [0.6148267526188558, 0.5765907305577376, 0.661150512214342, 0.6999208234362628, 0.6699846860643185]
C-Index-IPCW_Validation Set: 0.6301 ± 0.0566
 - List = [0.5785410925846505, 0.5595841986520141, 0.6265868510648779, 0.6776564659884546, 0.7083036576443925]
Test Summary:
C-Index_Test Set: 0.6574 ± 0.0554
 - List = [0.7553459119496856, 0.6406685236768802, 0.6745283018867925, 0.6215277777777778, 0.5948876839659178]
C-Index-IPCW_Test Set: 0.6125 ± 0.0531
 - List = [0.6542281416611474, 0.675476295078072, 0.6238134547195088, 0.5821372524455339, 0.5267924566427123]
Training run tcga_luad_run001 finished.

LUSC:
--- Testing Complete ---
Validation Summary:
C-Index_Validation Set: 0.6369 ± 0.0473
 - List = [0.5954332552693209, 0.7035573122529645, 0.6624863685932388, 0.5723720418271877, 0.6507027589796981]
C-Index-IPCW_Validation Set: 0.6240 ± 0.0194
 - List = [0.6087496677750677, 0.6536110115915568, 0.6288333886438928, 0.5975339198883582, 0.6311730356989936]
Test Summary:
C-Index_Test Set: 0.6277 ± 0.0488
 - List = [0.5519553072625698, 0.669882100750268, 0.6128374936321956, 0.6131868131868132, 0.6908094948265369]
C-Index-IPCW_Test Set: 0.6402 ± 0.0325
 - List = [0.5898736689441008, 0.6678710818681645, 0.6682392798383198, 0.6132074772570162, 0.6617532323460711]

    ...
    def forward(
        ...
        for layer_idx, layer in enumerate(self.layers):
            for i in range(self.modalities):
                ...
                # MODIFICATION: Use per-modality mask
...
class HealNetFusionModule(nn.Module):
    ...
    def __init__(
        ...
        self.healnet = HealNet(
            ...
            out_dims=embed_dim, # Final output feature dimension
            l_c=num_latents,    # Number of latent vectors (queries)
            l_d=embed_dim,      # Dimension of latent vectors
            depth=depth,
            x_heads=num_heads,
            l_heads=num_heads,

...
--- Testing Complete ---
Validation Summary:
C-Index_Validation Set: 0.6900 ± 0.0529
 - List = [0.6414182111200645, 0.6378633150039277, 0.6635145784081954, 0.7600950118764845, 0.7473200612557427]
C-Index-IPCW_Validation Set: 0.6887 ± 0.0534
 - List = [0.6382409932146118, 0.6653716935322652, 0.6371295065410703, 0.7329163924923568, 0.7698076116607343]
Test Summary:
C-Index_Test Set: 0.6587 ± 0.0686
 - List = [0.7377358490566037, 0.7270194986072424, 0.6300539083557951, 0.6479166666666667, 0.5507358636715725]
C-Index-IPCW_Test Set: 0.6468 ± 0.0757
 - List = [0.6942369797790013, 0.7633592085251418, 0.6319720063197011, 0.5996335815896234, 0.5449862202131232]
Training run tcga_luad_run029 finished.

KIRC:
--- Testing Complete ---
Validation Summary:
C-Index_Validation Set: 0.8128 ± 0.0333
 - List = [0.8338192419825073, 0.7503805175038052, 0.8108108108108109, 0.8457223001402524, 0.823088455772114]
C-Index-IPCW_Validation Set: 0.7759 ± 0.0453
 - List = [0.7961225788675002, 0.7073088949606972, 0.7381621838444037, 0.8146468948972821, 0.8230927810097994]
Test Summary:
C-Index_Test Set: 0.7730 ± 0.0446
 - List = [0.7762430939226519, 0.8082191780821918, 0.6868131868131868, 0.8049738219895288, 0.788515406162465]
C-Index-IPCW_Test Set: 0.7596 ± 0.0377
 - List = [0.7051931500862079, 0.8174196871179313, 0.7701019257387732, 0.7354279918226093, 0.7699818246864022]
Training run tcga_kirc_run032 finished.
"""
import sys
import os

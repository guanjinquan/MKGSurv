...
def TrainTransforms():
    ...
    return Compose([
        RandomResizedCrop(size=(448, 448), scale=(0.8, 1.0)),
...
class MultiOSCCDataset(Dataset):
    ...
    def __init__(self, mode="train"):
        ...
        self.npy_dir = os.path.join(self.dataset_dir, "Multi-OSCCPI-Npy-448")
    ...
    def __getitem__(self, index):
        ...
        # The loaded array is assumed to be in shape (6, H, W, C), e.g., (6, 224, 224, 3)
        assert images_array.shape[0] == 6, \
            f"Expected 6 images in the npy file, but got {images_array.shape[0]} for PID {pid}."

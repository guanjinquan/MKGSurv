...
python /home/Guanjq/NewWork/MedAlignFusion/Code/main_traintest_5fold.py \
    --gpu_id ${GPU_ID} \
    --runs_id ${RUN_ID} \
    --model_task "tcga_kirc" \
    --dataset "tcga_kirc" \
    --image_aggregater "panther" \
    --fusion_type "medkgat_fusion_wo_loss" \
    ...
    --modalities "tabular-clinical-6,genomics-genomics,image-pathology"  \

...
python /home/Guanjq/NewWork/MedAlignFusion/Code/main_train.py \
    --gpu_id ${GPU_ID} \
    --runs_id ${RUN_ID} \
    --model_task "multi_oscc_it" \
    --dataset "multi_oscc_it" \
    ...
    --modalities "all" \
    --continue_training \
    --load_pth_path "/home/Guanjq/NewWork/MedAlignFusion/Checkpoints/multi_oscc_it/multi_oscc_run0012+mibf_fusion-cp/Final_Trainer.pkl"

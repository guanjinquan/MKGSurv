...
OUTPUT_JSON_PATH = "/home/Guanjq/NewWork/MedAlignFusion/Data/TCGA-BRCA/processed/medical_analysis_qwen.json"
FAILED_LOG_PATH = "failed_ids_brca_qwen.log"
...
def process_patients():
    ...
    for _, row in df.iterrows():
        # TCGA-BRCA usually uses 'cases.submitter_id'
        raw_id = row.get('cases.submitter_id')
        
        if pd.isna(raw_id) or raw_id == "Not Available":
            continue

        # Force String & Strip to prevent duplicate keys logic error

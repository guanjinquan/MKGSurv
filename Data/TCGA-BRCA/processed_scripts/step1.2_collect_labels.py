...
BASE_PATH = '/home/Guanjq/NewWork/MedAlignFusion/Data/TCGA-BRCA'
SOURCE_PATH = os.path.join(BASE_PATH, 'source')
PROCESSED_PATH = os.path.join(BASE_PATH, 'processed')

# Input data directories
BIOSPECIMEN_DIR = os.path.join(SOURCE_PATH, 'biospecimen.project-tcga-brca.2025-12-03')
CLINICAL_DIR = os.path.join(SOURCE_PATH, 'clinical.project-tcga-brca.2025-12-03')

# Input patient list
PATIENT_LIST_PKL = os.path.join(SOURCE_PATH, 'brca_patients.pkl')

# Output file
OUTPUT_CSV = os.path.join(PROCESSED_PATH, 'brca_patient_labels.csv')
# OUTPUT_ID_LIST = os.path.join(PROCESSED_PATH, 'brca_final_patient_ids.txt')

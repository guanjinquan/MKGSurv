...
# --- 原始数据源 (Raw Data TSVs) ---
BIOSPECIMEN_DIR = os.path.join(SOURCE_DIR, "biospecimen.project-tcga-brca.2025-12-03")
CLINICAL_DIR = os.path.join(SOURCE_DIR, "clinical.project-tcga-brca.2025-12-03")
...
# --- 其他资源 ---
PATH_LABELS = os.path.join(PROCESSED_DIR, "brca_patient_labels.csv")
PATH_REPORTS = os.path.join(PROCESSED_DIR, "tcga_brca_reports.csv")

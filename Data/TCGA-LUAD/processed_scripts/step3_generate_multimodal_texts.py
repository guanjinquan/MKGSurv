...
# --- 原始数据源 (Raw Data TSVs) ---
BIOSPECIMEN_DIR = os.path.join(SOURCE_DIR, "biospecimen.project-tcga-luad.2025-10-31")
CLINICAL_DIR = os.path.join(SOURCE_DIR, "clinical.project-tcga-luad.2025-10-31")
...
# --- 其他资源 ---
PATH_LABELS = os.path.join(PROCESSED_DIR, "luad_patient_labels.csv")
PATH_REPORTS = os.path.join(PROCESSED_DIR, "tcga_luad_reports.csv")

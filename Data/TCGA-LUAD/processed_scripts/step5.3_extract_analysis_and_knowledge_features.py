...
def process_data_fusion(analysis_path: str, knowledge_path: str, output_path: str, max_augmentations: int = 10):
    ...
    for patient_id in tqdm(all_patient_ids, desc="Encoding Patients"):
        ...
        for modal_key in all_modal_keys:
            ...
            assert raw_relationship and raw_survival, f"Pat: {patient_id} Missing relationship or survival for modal key: {modal_key}"
            ...
            # --- 1. Original (Index 0) ---
            flat_text_batch.append(f"Score: {score}. Relationship Analysis: {raw_relationship}" if raw_relationship else "")

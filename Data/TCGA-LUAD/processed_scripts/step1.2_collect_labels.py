...
BASE_PATH = '/home/Guanjq/NewWork/MedAlignFusion/Data/TCGA-LUAD'
SOURCE_PATH = os.path.join(BASE_PATH, 'source')
PROCESSED_PATH = os.path.join(BASE_PATH, 'processed')

# Input data directories
BIOSPECIMEN_DIR = os.path.join(SOURCE_PATH, 'biospecimen.project-tcga-luad.2025-10-31')
CLINICAL_DIR = os.path.join(SOURCE_PATH, 'clinical.project-tcga-luad.2025-10-31')

# Input patient list
PATIENT_LIST_PKL = os.path.join(SOURCE_PATH, 'luad_patients.pkl')

# Output file
OUTPUT_CSV = os.path.join(PROCESSED_PATH, 'luad_patient_labels.csv')
# OUTPUT_ID_LIST = os.path.join(PROCESSED_PATH, 'luad_final_patient_ids.txt')

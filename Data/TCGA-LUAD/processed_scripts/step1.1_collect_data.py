...
def main():
    # --- 路径设置 ---
    # !! 重要: 请更新为您的实际路径 !!
    base_path = '/home/Guanjq/NewWork/MedAlignFusion/Data/TCGA-LUAD/source'
    save_path = '/home/Guanjq/NewWork/MedAlignFusion/Data/TCGA-LUAD/processed'
    ...
    # 原始文件路径
    biospecimen_dir = os.path.join(base_path, 'biospecimen.project-tcga-luad.2025-10-31')
    biospecimen_files = [
        os.path.join(biospecimen_dir, f) for f in ['aliquot.tsv', 'analyte.tsv', 'portion.tsv', 'sample.tsv', 'slide.tsv']
    ]
    clinical_dir = os.path.join(base_path, 'clinical.project-tcga-luad.2025-10-31')
    clinical_files = [

...
--- Testing Complete ---
Validation Summary:
C-Index_Validation Set: 0.6632 ± 0.0806
 - List = [0.5938759065269944, 0.5703063629222309, 0.6343577620173365, 0.7553444180522565, 0.7618683001531393]
C-Index-IPCW_Validation Set: 0.6586 ± 0.0755
 - List = [0.5704624121226703, 0.5977732309602158, 0.6311645342517099, 0.7280154333666881, 0.7655844754670336]
Test Summary:
C-Index_Test Set: 0.6538 ± 0.0761
 - List = [0.740251572327044, 0.7200557103064067, 0.6469002695417789, 0.6375, 0.5243996901626646]
C-Index-IPCW_Test Set: 0.6309 ± 0.0716
 - List = [0.6676709325788626, 0.7370677853912273, 0.6216393405280842, 0.6085071592719496, 0.5194811219308986]
"""
import sys
import os
...
class SafeCrossAttnEncoder(nn.Module):
    ...
    def __init__(self, embed_dim: int, num_heads: int = 8, dropout: float = 0.1, ffn_mult: int = 4):
        ...
        self.attn_gate = nn.LeakyReLU(0.1)  # 相当于attention只做加法不做减法？
        # 1. Attention 部分

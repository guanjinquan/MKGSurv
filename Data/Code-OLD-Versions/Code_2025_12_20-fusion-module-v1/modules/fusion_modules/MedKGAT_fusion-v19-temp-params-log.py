...
--- Testing Complete ---
Validation Summary:
C-Index_Validation Set: 0.8335 ± 0.0387
 - List = [0.8381924198250729, 0.7640791476407914, 0.8273273273273273, 0.8625525946704067, 0.8755622188905547]
C-Index-IPCW_Validation Set: 0.8024 ± 0.0504
 - List = [0.8168261738655218, 0.725386644785177, 0.7722386974281024, 0.8225277801736012, 0.8749508151157505]
Test Summary:
C-Index_Test Set: 0.7707 ± 0.0609
 - List = [0.787292817679558, 0.8051750380517504, 0.6497252747252747, 0.8075916230366492, 0.803921568627451]
C-Index-IPCW_Test Set: 0.7452 ± 0.0428
 - List = [0.7004728627014922, 0.8133350421520842, 0.7086266000825641, 0.7286128829361334, 0.7751676283839206]
Training run tcga_kirc_run035 finished.

LUAD:
--- Testing Complete ---
Validation Summary:
C-Index_Validation Set: 0.6819 ± 0.0464
 - List = [0.6583400483481063, 0.603299293008641, 0.6973995271867612, 0.7292161520190024, 0.7212863705972435]
C-Index-IPCW_Validation Set: 0.6657 ± 0.0389
 - List = [0.6311146724756959, 0.6213158318085237, 0.6526538680020775, 0.7125786119347003, 0.710805867950747]
Test Summary:
C-Index_Test Set: 0.6432 ± 0.0747
 - List = [0.660377358490566, 0.7479108635097493, 0.6495956873315364, 0.64375, 0.5143299767621998]
C-Index-IPCW_Test Set: 0.6182 ± 0.0851
 - List = [0.614193128210425, 0.7492829094495174, 0.6273341282819699, 0.6197927894343208, 0.4806348119328913]
Training run tcga_luad_run032 finished.
"""
import sys
import os

...
--- Testing Complete ---
Validation Summary:
C-Index_Validation Set: 0.6330 ± 0.0556
 - List = [0.7067381316998469, 0.5987107171635777, 0.6817102137767221, 0.6249014972419228, 0.5530243519245875]
C-Index-IPCW_Validation Set: 0.6069 ± 0.0844
 - List = [0.7220490279014715, 0.5254090150992572, 0.6734543495211431, 0.6129047605847902, 0.5007261245000015]
Test Summary:
C-Index_Test Set: 0.6180 ± 0.0409
 - List = [0.5948876839659178, 0.6974842767295597, 0.5819444444444445, 0.6057951482479784, 0.6100278551532033]
C-Index-IPCW_Test Set: 0.5770 ± 0.0389
 - List = [0.5320697236651483, 0.619524265098731, 0.5573229743503707, 0.5485069359728645, 0.6273700237886726]
...
class MedKGATFusion(nn.Module):
    ...
    def save_features_for_umap(self, group_embeddings, group_masks, fused_embedding):
        ...
        for i, (g_feat, g_mask) in enumerate(zip(group_embeddings, group_masks)):
            mean_emb = masked_mean_pool(g_feat, g_mask)

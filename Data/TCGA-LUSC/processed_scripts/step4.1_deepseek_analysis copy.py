...
[
    {{
        ...
        "knowledge":  [A long text paragraph analyzing the association between the two modalities of data and the related survival analysis knowledge of these content, including your perspective on their relationship as detailed as possible],
    }},

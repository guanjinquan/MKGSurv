...
def main():
    # --- 路径设置 ---
    # !! 重要: 请更新为您的实际路径 !!
    base_path = '/home/Guanjq/NewWork/MedAlignFusion/Data/TCGA-LUSC/source'
    save_path = '/home/Guanjq/NewWork/MedAlignFusion/Data/TCGA-LUSC/processed'
    ...
    # 原始文件路径
    biospecimen_dir = os.path.join(base_path, 'biospecimen.project-tcga-lusc.2025-11-08')
    biospecimen_files = [
        os.path.join(biospecimen_dir, f) for f in ['aliquot.tsv', 'analyte.tsv', 'portion.tsv', 'sample.tsv', 'slide.tsv']
    ]
    clinical_dir = os.path.join(base_path, 'clinical.project-tcga-lusc.2025-11-08')
    clinical_files = [

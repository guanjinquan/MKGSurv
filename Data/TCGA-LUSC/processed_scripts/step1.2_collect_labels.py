...
BASE_PATH = '/home/Guanjq/NewWork/MedAlignFusion/Data/TCGA-LUSC'
SOURCE_PATH = os.path.join(BASE_PATH, 'source')
PROCESSED_PATH = os.path.join(BASE_PATH, 'processed')

# Input data directories
BIOSPECIMEN_DIR = os.path.join(SOURCE_PATH, 'biospecimen.project-tcga-lusc.2025-11-08')
CLINICAL_DIR = os.path.join(SOURCE_PATH, 'clinical.project-tcga-lusc.2025-11-08')

# Input patient list
PATIENT_LIST_PKL = os.path.join(SOURCE_PATH, 'lusc_patients.pkl')

# Output file
OUTPUT_CSV = os.path.join(PROCESSED_PATH, 'lusc_patient_labels.csv')

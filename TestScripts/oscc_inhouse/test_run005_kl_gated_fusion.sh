...
python /home/Guanjq/NewWork/MedAlignFusion/Code/main_test.py \
    ...
    --modalities "all" \
    --continue_training \
    --load_pth_path "/home/Guanjq/NewWork/MedAlignFusion/Checkpoints/oscc_inhouse_it/inhouse_run005+kl_gated-cp/Final_Trainer.pkl"

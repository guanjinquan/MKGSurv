...
RUN_ID="oscc_inhouse_run014_ood_200epoch"
...
python /home/Guanjq/NewWork/MedAlignFusion/Code/main_test.py \
    ...
    --modalities "image-pathology,text-clinical,tabular-metadata-4,tabular-history-9,tabular-blood-5,text-treatment" \
    --do_mixup \
    --do_mixup_only_treatment

...
# ==========================================
class HealNet_Group_v4(nn.Module):
    """
    ...
    def forward(
        ...
        **kwargs
        ...
        for group_indices in embeddings_groups:
            ...
            # scale
            g_feat = g_feat * len(group_indices)
        ...
        for layer_idx, layer in enumerate(self.layers):
            ...
            for i, group_emb in enumerate(group_embeddings):
                ...
                # Mask handling
                context_mask = group_masks[i] > 0 if group_masks[i] is not None else None

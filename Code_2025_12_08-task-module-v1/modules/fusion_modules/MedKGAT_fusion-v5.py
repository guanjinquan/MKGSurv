...
--- Testing Complete ---
Validation Summary:
C-Index_Validation Set: 0.6648 ± 0.0425
 - List = [0.6381950040290089, 0.605655930871956, 0.6540583136327817, 0.7078384798099763, 0.7182235834609495]
C-Index-IPCW_Validation Set: 0.6429 ± 0.0587
 - List = [0.6173438993654782, 0.5820474053905088, 0.5933053264421311, 0.6872603509445772, 0.734710412433533]
Test Summary:
C-Index_Test Set: 0.6381 ± 0.0701
 - List = [0.7075471698113207, 0.7116991643454039, 0.6442048517520216, 0.6034722222222222, 0.5236250968241674]
C-Index-IPCW_Test Set: 0.6078 ± 0.0812
 - List = [0.6094859508395448, 0.7426348422825738, 0.611863986055004, 0.5872635713380128, 0.4879499064362331]
Training run tcga_luad_run001 finished.

LUSC:
--- Testing Complete ---
Validation Summary:
C-Index_Validation Set: 0.6801 ± 0.0350
 - List = [0.680327868852459, 0.7182382834556748, 0.7099236641221374, 0.6191524490919097, 0.6730869338885996]
C-Index-IPCW_Validation Set: 0.6450 ± 0.0280
 - List = [0.6911135536672911, 0.6553811844395661, 0.634771069023101, 0.6060174553770155, 0.6379523130961039]
Test Summary:
C-Index_Test Set: 0.6628 ± 0.0259
 - List = [0.6307262569832403, 0.6913183279742765, 0.6459500764136525, 0.6505494505494506, 0.6956786366402922]
C-Index-IPCW_Test Set: 0.6791 ± 0.0226
 - List = [0.6640898002320123, 0.6930996209060921, 0.7005779100949735, 0.6957375547700796, 0.6417789297044907]

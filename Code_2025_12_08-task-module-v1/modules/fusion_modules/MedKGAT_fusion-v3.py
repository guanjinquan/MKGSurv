...
--- Testing Complete ---
Validation Summary:
C-Index_Validation Set: 0.6617 ± 0.0402
 - List = [0.6438356164383562, 0.5970149253731343, 0.6627265563435776, 0.714172604908947, 0.6906584992343032]
C-Index-IPCW_Validation Set: 0.6477 ± 0.0567
 - List = [0.6255653653562118, 0.5608184435972168, 0.6344291542180865, 0.694614444296204, 0.7228642718040323]
Test Summary:
C-Index_Test Set: 0.6506 ± 0.0779
 - List = [0.7333333333333333, 0.729108635097493, 0.6455525606469003, 0.6229166666666667, 0.5220759101471727]
C-Index-IPCW_Test Set: 0.6257 ± 0.0861
 - List = [0.621752726887568, 0.7675095740348782, 0.6170578947092297, 0.6260236464192012, 0.49597562161367253]
Training run tcga_luad_run001 finished.

LUSC:
--- Testing Complete ---
Validation Summary:
C-Index_Validation Set: 0.6841 ± 0.0416
 - List = [0.6779859484777517, 0.6984754376058724, 0.7420937840785169, 0.6130985140341222, 0.6887038001041125]
C-Index-IPCW_Validation Set: 0.6578 ± 0.0324
 - List = [0.6958696471295412, 0.6506513482569247, 0.6576135500968691, 0.6019754955421696, 0.6831099628191136]
Test Summary:
C-Index_Test Set: 0.6567 ± 0.0257
 - List = [0.6318435754189944, 0.680064308681672, 0.6464595007641365, 0.6313186813186813, 0.6938527084601339]
C-Index-IPCW_Test Set: 0.6758 ± 0.0143
 - List = [0.678017109498518, 0.6751627027744825, 0.6997020743328142, 0.6552984861519627, 0.6710538536101757]

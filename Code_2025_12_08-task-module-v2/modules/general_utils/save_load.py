...
def load_model(path):
    ...
    # # # 更新 fusion_fusion_block -> fusion_module.fusion_block
    # for name in list(checkpoint['model'].keys()):
    #     if "fusion_fusion_block" in name:
    #         new_name = name.replace("fusion_fusion_block", "fusion_module.fusion_block")
    #         checkpoint['model'][new_name] = checkpoint['model'].pop(name)

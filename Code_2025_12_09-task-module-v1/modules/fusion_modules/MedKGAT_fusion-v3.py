...
--- Testing Complete ---
Validation Summary:
C-Index_Validation Set: 0.6380 ± 0.0484
 - List = [0.6898928024502297, 0.5962933118452861, 0.6935866983372921, 0.6367218282111899, 0.5734485467399842]
C-Index-IPCW_Validation Set: 0.6184 ± 0.0571
 - List = [0.7015592060238722, 0.567820658896806, 0.6541914335319357, 0.6241853061700146, 0.5441105423336757]
Test Summary:
C-Index_Test Set: 0.6411 ± 0.0618
 - List = [0.5716498838109992, 0.7037735849056603, 0.5659722222222222, 0.6556603773584906, 0.708217270194986]
C-Index-IPCW_Test Set: 0.6019 ± 0.0654
 - List = [0.5404617440401082, 0.6294483291846619, 0.5152445162933161, 0.6303969491014355, 0.6941491225942023]
...
class MedKGATFusion(nn.Module):
    ...
    def forward(
        ...
        if len(all_edge_scores_list) > 0 and edge_score_valid_flag:
            ...
            scaled_dots = dots_masked * scale_factor # Scale logits before Softmax

            pred_log_probs = F.log_softmax(scaled_dots, dim=1) 
